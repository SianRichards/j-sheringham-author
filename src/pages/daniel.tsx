        ...
        return (<React.Fragment>
            <article className={styles.daniel}>
                <div className={styles.description}>
                    ...
                    <a href='https://www.amazon.co.uk/Daniel-Jo-Sheringham-ebook/dp/B01N9VNM2S/ref=pd_sbs_351_1/259-9137129-8314455?_encoding=UTF8&pd_rd_i=B01N9VNM2S&pd_rd_r=df30f4ca-9343-11e9-8204-3741c703b808&pd_rd_w=oaHk4&pd_rd_wg=rv8UC&pf_rd_p=18edf98b-139a-41ee-bb40-d725dd59d1d3&pf_rd_r=Z8YT8SSS0XCTSMCG29CP&psc=1&refRID=Z8YT8SSS0XCTSMCG29CP' target="_blank">
