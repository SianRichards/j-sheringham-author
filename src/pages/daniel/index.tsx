    ...
    <article className={styles.daniel}>
      <div className={styles.description}>
        ...
        <p>
          ...
          genius-king, yearns to excel in scientific endeavour. In an imaginary,
          frozen landscape, the snow and ice of Babylon become home and as time
          passes, any thoughts of returning to the land of his youth evaporate.
        </p>
        <p>
          ...
          both their public and private anxieties. Falling in and out of favour,
          Daniel and his friends find themselves either working at the top level
          of government or threatened with execution. They fall prey to both the
          whims of monarchs and the political traps of rivals.
        </p>
        <p>
          Based on the Old Testament book of Daniel, this story is not unique in
          itself; the novelty lies in its retelling. A dramatic tale of faith
          and adventure, it contains all the familiar elements: captivity and
          kingship; dreams and interpretations; looming execution and miraculous
          rescue; the writing on the wall and the den of lions. A futuristic,
          fantastical context highlights the epic, broad sweep of a towering
          tale.
        </p>
      </div>
