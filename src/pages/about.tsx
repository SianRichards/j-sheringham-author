        ...
        return (<React.Fragment>
            <article className={styles.main}>
                ...
                <div className={styles.bio}><h1>Author</h1><p>As a scruffy teenager, Jo had no thoughts of writing until at school a short story competition deadline loomed. To avoid detention she scrawled something out on scrap paper and forgot all about it. A surprise to everyone she did rather well but any serious thoughts about writing were shelved.</p>
                    ...
                    <p>Inspired by a dream and a popular song, My Detective Darling was duly completed. The writing flowed and a story emerged and Jo started to think that perhaps she could do this again…</p>
                    <p>Jo then wrote From Inside – four mysterious tales, just a little bit dark and a little bit odd. The main inspiration being one of her father’s stories, invented to amuse restless children during long car journeys.</p>
