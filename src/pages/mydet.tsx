    ...
    render() {
        return (<React.Fragment><article className={styles.myDet}>
            <div className={styles.description}>
                ...
                <p>
                    Traveling through time and space is one thing.
                    ...
                    horses and homecomings
            </p>
                <p className={styles.quote}>"But what has been will be - first memory, then oblivion’s swallowing sea;
                Like men foregone, shall we merge into those Whose story no one knows."
            </p>
