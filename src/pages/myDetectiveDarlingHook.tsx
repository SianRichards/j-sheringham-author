    ...
    <React.Fragment>
      <article className={styles.myDet}>
        <div className={styles.description}>
          ...
          <p>
            Traveling through time and space is one thing. Traveling through
            time and space with Charlie Darling, a
            self-proclaimed-inter-continental-dimensional detective, is quite
            another. In this perplexing tale of odd relationships, forgiveness,
            and things that suddenly get rather hot for no apparent reason,
            there are dreams and deserts, temples and towers; sand dunes and
            storms, fear and flight, horses and homecomings.
          </p>
