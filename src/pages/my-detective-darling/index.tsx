  ...
  return (
    <article className={styles.myDet}>
      <div className={styles.description}>
        ...
        <p>
          <em>
            "They say these things happen all too fast, but this was slow, very
            slow. Jane heard herself shout... The suitcase broke into points of
            white light as her hand fused to the handle. And then she was gone."
          </em>
        </p>
        <p>
          ...
          against her better judgement Jane engages his services, and before she
          knows it, is unwittingly dumped into an infinite desert. She must lose
          her way before finding it again.
        </p>
        <p>
          Gavin - Charlie and Margaret Darling's troubled son - cannot shake off
          a stubborn dream. Without warning, he too is catapulted into the
          desert. Here, where the sun always shines and the sand goes on
          forever, everything begins to make sense. And he finds a city of gold
          which takes his breath away.
        </p>
        <p>
