    ...
    <article className={styles.taleOfTwoProphets}>
      <div className={styles.imageAndBlurb}>
        ...
        <div className={styles.blurb}>
          ...
          <p className={styles.blurbText}>
            ...
            lives they bring fresh insight, wonder, depth and grandeur to the
      ...
      <div className={styles.quotes}>
        ...
        <p>
          ...
          and I'll give you a picture”. Jo has followed in the steps of so many
          famous film makers, taking a few chapters of the Book of Kings and
          letting her imagination loose. In this “Mad Max” like world Jo
          re-imagines Elijah and Elisha criss-crossing a dystopian landscape on
          everything from solar powered craft to spaceships, pickups to buses.
          Strangely the story of these prophets is the only epic tale that has
